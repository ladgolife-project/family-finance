...
export default async function NewTransferPage() {
  ...
  async function createTransfer(formData: FormData) {
    ...
    // Seluruh validasi family, rekening, saldo,
    // dan proses INSERT dilakukan oleh database function.
  ...
  // Gunakan tanggal lokal untuk menghindari risiko
  // tanggal mundur akibat konversi UTC.
    ...
    <main className="min-h-screen bg-gray-50 px-6 py-10 text-gray-500">
      <div className="mx-auto max-w-xl">
        ...
        <p className="mt-1 text-sm text-gray-500">
          Pindahkan dana tanpa memengaruhi total cash flow.
        </p>
